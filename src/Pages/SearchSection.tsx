...
const data2 = [
  ...
  {
      "artist": {
          "avatar": "https://is5-ssl.mzstatic.com/image/thumb/Music/v4/a3/0f/07/a30f0744-d6a3-5e89-34c2-90db76b6b3c5/5054316029410_cover.jpg/800x800ac.jpg",
          "name": "Kiss The Rain",
          "verified": false,
...
const trackData1 =  [
      {
          "track": {
              ...
              "share": {
                  ...
                  "image": "https://is3-ssl.mzstatic.com/image/thumb/Music114/v4/02/74/5a/02745ac2-cbfb-a90a-b970-7449be5d4c42/06UMGIM10734.rgb.jpg/400x400cc.jpg",
                  ...
                  "avatar": "https://is5-ssl.mzstatic.com/image/thumb/Features124/v4/4e/0d/1f/4e0d1ff5-9f2e-0170-0ec9-3dbe25f3a471/pr_source.png/800x800cc.jpg",
              ...
              "images": {
                  ...
                  "coverart": "https://is3-ssl.mzstatic.com/image/thumb/Music114/v4/02/74/5a/02745ac2-cbfb-a90a-b970-7449be5d4c42/06UMGIM10734.rgb.jpg/400x400cc.jpg",
                  "coverarthq": "https://is3-ssl.mzstatic.com/image/thumb/Music114/v4/02/74/5a/02745ac2-cbfb-a90a-b970-7449be5d4c42/06UMGIM10734.rgb.jpg/400x400cc.jpg",
      ...
      },
      {
          "track": {
              ...
              "share": {
                  ...
                  "image": "https://is2-ssl.mzstatic.com/image/thumb/Music4/v4/ae/74/6f/ae746f79-c0e7-bd13-bdf0-a39cb5fefe12/5051813914621_cover.jpg/400x400cc.jpg",
                  "twitter": "I used @Shazam to discover Falling In the Sky by Kiss The Rain.",
              ...
              "images": {
                  "background": "https://is2-ssl.mzstatic.com/image/thumb/Music4/v4/ae/74/6f/ae746f79-c0e7-bd13-bdf0-a39cb5fefe12/5051813914621_cover.jpg/400x400cc.jpg",
                  "coverart": "https://is2-ssl.mzstatic.com/image/thumb/Music4/v4/ae/74/6f/ae746f79-c0e7-bd13-bdf0-a39cb5fefe12/5051813914621_cover.jpg/400x400cc.jpg",
                  "coverarthq": "https://is2-ssl.mzstatic.com/image/thumb/Music4/v4/ae/74/6f/ae746f79-c0e7-bd13-bdf0-a39cb5fefe12/5051813914621_cover.jpg/400x400cc.jpg",
...
const SearchSection = () => {
  ...
  const searchResult = useSelector((state : RootState) => state.playList.searchResult);
  ...
  return (
    <section id="searchSection" className="mx-5 my-3 mainBody">
      ...
      <div className="d-flex justify-content-between">
            ...
            placeholder="Search"
            />
            <button type="button" className="btn btn-outline-dark mx-5 my-3 p-2" onClick={() => dispatch(fetchSearchList({term : searchText} ))}>Search</button>
      </div>
      TrackData
      <div className="d-flex flex-wrap">
       {
        data?.map((ele:any) => {
          return <Card ele={ele} image={ele?.track?.share?.image} name={ele?.track?.share?.subject}  /> 
